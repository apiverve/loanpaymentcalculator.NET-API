...
namespace APIVerve
{
    public class LoanCalculatorAPIClient
    {
        ...
        public LoanCalculatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public LoanCalculatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, loanpaymentcalculatorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(loanpaymentcalculatorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(loanpaymentcalculatorQueryOptions options)
        {
